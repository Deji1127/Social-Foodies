...
export async function getNearbySearchRequest() {
    ...
    //ignore the error warning, it does not stop the program
    return {
...
//how to call the functions from elsewhere
// import { initMap, getCurrentLocation } from './gMap.tsx'; // Ensure you have the correct file extension
...
// // Example usage of getCurrentLocation
