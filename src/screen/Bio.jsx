...
const Bio = () => {
 ...
 <Image source={require('../assets/social1.png')} style={styles.logoOnly} />
 </View>
 ...
 {editMode ? (
 <TextInput style={styles.input} value={bio} onChangeText={setBio} placeholder="Write something about yourself..." multiline numberOfLines={3} />
 ) : (
 ...
 <Feather name={editMode ? "check" : "edit"} size={28} color="#B40324" />
